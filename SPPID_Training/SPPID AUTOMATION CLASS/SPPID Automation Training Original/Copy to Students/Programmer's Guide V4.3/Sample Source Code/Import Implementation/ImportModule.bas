...
Public Const CONST_EndPrepAttributeName As String = "EndPrep"
Public Const CONST_RatingAttributeName As String = "Rating"
...
Public Const CONST_PipingPointItemName As String = "PipingPoint"
...
Public Sub ShowProgressBar(objProgressBar As igrProgressBar412.clsProgressBar)
    
    Set objProgressBar = New igrProgressBar412.clsProgressBar
    With objProgressBar
        .PBMin = 0
        .PBMax = 100
        .PBHeight = 300
