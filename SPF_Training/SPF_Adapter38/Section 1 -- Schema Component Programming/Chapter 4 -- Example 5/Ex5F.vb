...
Friend Class Ex5F
	...
	Private Sub cmdDoIt_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdDoIt.Click
		...
		' =============================================================================================================================================
		WriteLn("1. Example of FindObjects on Schema (Enumlists & EnumEnums of Pi*)")
		collObjects = New IntfcProp.ObjectCollection
		Call oSchemaContainer.IContainerQuery.FindObjects("EnumListType~EnumEnum", "", "Pi*", "", False, collObjects)
		WriteLnIObjectCollection(collObjects)

		' =============================================================================================================================================
		WriteLn("3. Example of FindObjects on Data (all Pipelines)")
		collObjects = New IntfcProp.ObjectCollection
		Call oDataContainer.IContainerQuery.FindObjects("PIDPipeline", "", "*", "", False, collObjects)
		WriteLnIObjectCollection(collObjects)
		
		' =============================================================================================================================================
		WriteLn("4. Example of FindObjects on Data (control valves)")
		collObjects = New IntfcProp.ObjectCollection
		Call oDataContainer.IContainerQuery.FindObjects("PIDInlineInstrument", "", "CV*", "", False, collObjects)
		WriteLnIObjectCollection(collObjects)
		
		' =============================================================================================================================================
		WriteLn("5. Example of FindObjects on Data (equipment)")
		collObjects = New IntfcProp.ObjectCollection
		Call oDataContainer.IContainerQuery.FindObjects("PIDProcessEquipment", "", "*", "", False, collObjects)
		WriteLnIObjectCollection(collObjects)
