...
Friend Class Ex3F
	...
	Private Sub cmdDoIt_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdDoIt.Click
		...
		'// Using IContainerQuery to get schema (ClassDef)
		'//
        oObject = oSchemaContainer.IContainerQuery.GetIObjectForUID("PIDProcessEquipment")
		WriteLnIObject(oObject)
		
		'// Using IContainerQuery on the data container to get instance data
		'//
        oObject = oDataContainer.IContainerQuery.GetIObjectForUID("89B6EAE0EEC145F8878262D8A5AAB978")
		WriteLnIObject(oObject)
