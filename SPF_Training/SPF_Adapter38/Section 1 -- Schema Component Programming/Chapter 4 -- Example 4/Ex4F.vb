...
Friend Class Ex4F
	...
	Private Sub cmdDoIt_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdDoIt.Click
		...
		' =============================================================================================================================================
		WriteLn("Example of GetInstancesForClassDef on Schema")
		collObjects = New IntfcProp.ObjectCollection
		Call oSchemaContainer.IContainerQuery.GetInstancesForClassDef("ClassDef", collObjects)
		WriteLnIObjectCollection(collObjects)
		
		' =============================================================================================================================================
		WriteLn("Example of GetInstancesForClassDef on Data")
		collObjects = New IntfcProp.ObjectCollection
		Call oDataContainer.IContainerQuery.GetInstancesForClassDef("PIDInstrument", collObjects)
		WriteLnIObjectCollection(collObjects)
